...
BLOG_AUTHOR = "Fatima Kahil"  # (translatable)
BLOG_TITLE = "Fatima Kahil"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://fakahil.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "fakahil92@gmail.com"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/solo/','Solar Orbiter'),
        ('/talks/','Talks & Posters'),
        ('/teaching/','Teaching & Outreach'),
        #('/arabic/',"المدونة"),
        ("/about-me/","Contact"),
        #("/listings/kahil_CV.pdf/",'CV'),
    ),
}
...
PAGES = (
    ("journal/*.rst", "journal", "post.tmpl"),
    ("sunrise/*.rst", "sunrise", "post.tmpl"),
    ("sunrise/*.ipynb", "sunrise", "post.tmpl"),
    ("solo/*.rst", "solo", "post.tmpl"),
    ("solo/*.ipynb", "solo", "post.tmpl"),
    ("arabic/*.rst", "arabic", "post.tmpl"),
    ("coding/*.rst", "coding",'post.tmpl'),
    ("coding/*.ipynb", "coding", "post.tmpl"),
    ("talks/*.ipynb", "talks", "post.tmpl"),
    ("talks/*.rst", "talks",'post.tmpl'),
    ("teaching/*.rst", "teaching",'post.tmpl'),
    ("teaching/*.ipynb", "teaching",'post.tmpl'),
...
REDIRECTIONS = []#[("journal/first-world-bullshit.rst","https://fakahil.github.io/journal/first-world-bullshit.html/")]
